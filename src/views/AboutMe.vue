  ...
  <GauzyBackground :background="require('@/assets/beach.jpeg')">
    <div class="grid two-columns">
      ...
      <div class="card">
        ...
        <p>
          I have nearly 10 years of experience helping adults and couples to
          learn more about patterns in their thoughts, feelings, and behaviors,
          ...
          collaborative apporach to therapy and am skilled at tailoring
          evidence-based treatments to fit your individual goals.
        </p>
        <p>
          ...
          your needs - as best as I am able. My goal is to support you in
          learning more about the ways you experience your thoughts, feelings,
          and behavior across different situations and to discuss or practice
          different ways to help you reach your life goals.
        </p>
        <p>
        ...
        <p>
          Above all, you are the expert on your experience and I look forward to
          learning from and with you. I've been fortunate to meet and work with
          hundreds of people who identify with a range of backgrounds and life
          experiences. My goal is to work towards understanding how your
          perspective is shaped by your identity and life experiences and to to
          be mindful of the ways in which I may be limited in fully
          understanding <span class="oblique">all</span> aspects of your
          experience.
        </p>
        <p>
          I'm so happy you're taking this courageous step towards improving your
          understanding of yourself, your history, your needs, and your goals!
      ...
      <div class="card">
        ...
        <p>
          I practice flexibily and collaboratively, primarily using
          cognitive-behavioral, mindfulness or acceptance-based, or
          dialectical-behavioral approaches to provide treatment for symptoms of
          anxiety, trauma or PTSD, OCD, substance misuse, or chronic thoughts of
          sucide.
        </p>
        Therapeutic approaches consistent with my training and experience are
        often known as:
        <ul>
      ...
      <div class="card">
        ...
        <ul>
          ...
          <li>
            Advanced training in Dialectical Behavior Therapy and Prolonged
            Exposure, Center for Suicide Prevention and Recovery, University of
            Washington
          </li>
          <li>
            Research Fellowships in Psychology and Alcohol Research, University
            of Washington
          </li>
        </ul>
      </div>
